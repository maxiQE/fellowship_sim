...
from fellowship_sim.elarion.setup_effect import ElarionTalent, ElarionTalentSelection
...
class TestElarionTalentSelection:
    def test_talent_selection_within_budget_does_not_raise(self, unit_elarion__zero_stats: Elarion) -> None:
        ...
        sel = ElarionTalentSelection(talents=[ElarionTalent.PATH_OF_TWILIGHT], total_talent_points=1)
    ...
    def test_talent_selection_over_budget_raises(self, unit_elarion__zero_stats: Elarion) -> None:
        ...
        with pytest.raises(ValueError):
            sel = ElarionTalentSelection(talents=[ElarionTalent.PATH_OF_TWILIGHT, ElarionTalent.MAGIC_WARD], total_talent_points=1)
