...
class TestDeathsGrasp:
    ...
    def test_adds_3_percent_spirit(self, state_always_procs__st: State, unit_elarion__zero_stats: Elarion) -> None:
...
class TestDrakheimsAbsolution:
    ...
    def test_ultimate_cast_applies_main_stat_buff(
        ...
        before = elarion.stats.main_stat
        state_always_procs__st.bus.emit(UltimateCast(ability=elarion.skystrider_supremacy, owner=elarion, target=enemy))
...
class TestDarkProphecyBuff:
    ...
    def test_adds_25_percent_haste(self, state_always_procs__st: State, unit_elarion__zero_stats: Elarion) -> None:
...
class TestDraconicMightBuff:
    ...
    def test_adds_18_percent_main_stat(self, state_always_procs__st: State, unit_elarion__zero_stats: Elarion) -> None:
