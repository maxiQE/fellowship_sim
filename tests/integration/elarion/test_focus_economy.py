...
class TestFocusCost:
    ...
    def test_celestial_shot_costs_15_focus(self, state_always_procs__st: State, unit_elarion__zero_stats: Elarion) -> None:
    ...
    def test_volley_costs_30_focus(self, state_always_procs__st: State, unit_elarion__zero_stats: Elarion) -> None:
...
class TestFocusGain:
    ...
    def test_focused_shot_gains_20_focus(self, state_always_procs__st: State, unit_elarion__zero_stats: Elarion) -> None:
...
class TestFocusRegen:
    ...
    def test_focus_regen_rate(
        ...
        state_always_procs__st.advance_time(dt)
...
class TestFocusClipping:
    ...
    def test_focus_regen_clips_at_max_focus(self, state_always_procs__st: State, unit_elarion__zero_stats: Elarion) -> None:
